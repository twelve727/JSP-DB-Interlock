...
public class Student {
	...
	public String toString() {
		return "Student [studentNo=" + studentNo + ", studentName=" + studentName + ", studentAddress=" + studentAddress
				+ ", departmentName=" + departmentName + ", getStudentNo()=" + getStudentNo() + ", getStudentName()="
				+ getStudentName() + ", getStudentAddress()=" + getStudentAddress() + ", getDepartmentName()="
				+ getDepartmentName() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
}
