...
<body>
	...
	<pre>
		...
		(if, for, 배열/컬렉션 길이, 문자열 치환,
		숫자 데이터 형식 변경, 데이터 파싱, scope 변수 선언 등)
	</pre>
	...
	<h4> ${num2} </h4> <!-- 20, 변수명 똑같은데 페이지가 우선순위인 value값  -->
	...
	<pre>
		...
		- c:move 속성
		1) var : 삭제할 변수명
		2) scope : 삭제할 내장 객체 범위(기본 값 : 모든 범위)
	</pre>
	...
	<pre>
		...
		*주의 사항*
		1) test 속성 값 작성은 무조건 [ EL 구문 ] 이여야만 한다.
		2) test 속성 값 "" 안에는 [ 공백X ]
	</pre>
